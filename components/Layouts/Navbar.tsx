    ...
    <nav className="p-4 md:py-8 xl:px-0 md:container md:mx-w-6xl md:mx-auto">
      ...
      <Link href="/">
        ...
        <ul className="flex items-center space-x-4 text-sm font-semibold">
          <li>
            <Link href="/dashboard">
            <a href="#" className="px-2 xl:px-4 py-2 text-gray-800 rounded-md hover:bg-gray-200">Dashboard</a>
          ...
          <li className="relative" x-data="{ open: false }">
            <a href="#" className="px-2 xl:px-4 py-2 text-gray-600 rounded-md hover:bg-gray-200 flex gap-2 items-center">
              Transactions
